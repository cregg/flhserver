...
object YahooRoutes {
  ...
  val usersTeams = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20fantasysports.teams%20where%20game_key%3D%22352%22%20and%20use_login%3D1&format=json&diagnostics=true&callback="
